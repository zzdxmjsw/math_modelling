...
def addFloor(e):
    ...
    for j in range(elevatorNumber, len(e)):
        e[j] += 1
    return e
...
def printeleLoop(e):
    ...
    for i in range(1, len(e)):
        ...
        info = 'Elevator #%d, time for loop %d seconds, ' % (i, curr)
        info += 'carrying an average of '
        info += '%3.2f people per carry' % avgCarry
        print(info)
    print('')
